...
int main(int argc, char** argv)
{
	...
	const int base_addr = 0x43C00000; // end: 0x43C00FFF
	...
	(*(volatile uint32_t *)(&core->state)) = 0x0001;

	/* start core */
	(*(volatile uint32_t *)(&core->control)) |= 0x0001;

	getchar();

	/* switch LED 1 off */
	(*(volatile uint32_t *)(&core->led)) = 0x0001;
	(*(volatile uint32_t *)(&core->state)) = 0x0000;

	/* stop core */
	(*(volatile uint32_t *)(&core->control)) &= 0xFFFE;
